package liferay.travel.rest.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/liferay-travel-rest/v1.0
 *
...
public interface StageResource {
	...
	public Response postTripStageBatch(
			Long tripId, String callbackURL, Object object)
		throws Exception;

	public void deleteStage(Long stageId) throws Exception;

	public Response deleteStageBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Response putStageBatch(String callbackURL, Object object)
		throws Exception;
